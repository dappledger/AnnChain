...
func (r *Receipt) EncodeRLP(w io.Writer) error {
	return rlp.Encode(w, []interface{}{r.PostState, r.CumulativeGasUsed, r.Bloom, r.Logs, r.Height})
}
...
func (r *Receipt) DecodeRLP(s *rlp.Stream) error {
	...
	r.PostState, r.CumulativeGasUsed, r.Bloom, r.Logs, r.Height = receipt.PostState, receipt.CumulativeGasUsed, receipt.Bloom, receipt.Logs, receipt.Height
	return nil
}
...
func (r *Receipt) String() string {
	return fmt.Sprintf("receipt{med=%x cgas=%v bloom=%x logs=%v height=%v}", r.PostState, r.CumulativeGasUsed, r.Bloom, r.Logs, r.Height)
}
...
const tooFewElemError = "too few elements"
...
func (r *ReceiptForStorage) DecodeRLP(s *rlp.Stream) error {
	...
	if err := s.Decode(&receipt); err != nil && strings.Index(err.Error(), tooFewElemError) < 0 {
		return err
	}
