...
import (
	...
	"github.com/dappledger/AnnChain/genesis/eth/common/mclock"
...
func (self *BlockChain) InsertChain(chain types.Blocks) (int, error) {
	...
	var (
		...
		coalescedLogs []*genesistypes.Log
...
func (self *BlockChain) postChainEvents(events []interface{}, logs []*genesistypes.Log) {
