...
type NodeIterator struct {
	...
	accountHash ethcmn.Hash // Hash of the node containing the account
	codeHash    ethcmn.Hash // Hash of the contract source code
	code        []byte      // Source code associated with a contract

	Hash   ethcmn.Hash // Hash of the current entry being iterated (nil if not standalone)
...
func (it *NodeIterator) step() error {
	...
	if !bytes.Equal(account.CodeHash, emptyCodeHash) {
		it.codeHash = ethcmn.BytesToHash(account.CodeHash)
...
func (it *NodeIterator) retrieve() bool {
	...
	it.Hash, it.Entry = ethcmn.Hash{}, nil
