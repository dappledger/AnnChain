...
type operation struct {
	...
	gasCost gasFunc
	// baseGasCost only returns the base gas required for execution, op like CALL, when is nil, use gasCost instead
	baseGasCost gasFunc
...
func newHomesteadInstructionSet() [256]operation {
	...
	instructionSet[DELEGATECALL] = operation{
		...
		baseGasCost:   baseGasDelegateCall,
		validateStack: makeStackFunc(6, 1),
