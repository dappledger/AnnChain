...
func init() {
	...
	config.Set("connection_reset_wait", time.Second)
}
...
func TestSwitches(t *testing.T) {
	...
	config.Set("connection_reset_wait", int(time.Second))
...
func BenchmarkSwitches(b *testing.B) {
	...
	log.Warn(gcmn.Fmt("success: %v, failure: %v", numSuccess, numFailure))
