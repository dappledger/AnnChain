...
import (
	...
	events "github.com/annchain/ann-module/lib/go-events"
...
func TestByzantine(t *testing.T) {
	...
	case <-tick.C:
		for i, reactor := range reactors {
			t.Log(gcmn.Fmt("Consensus Reactor %v", i))
			t.Log(gcmn.Fmt("%v", reactor))
		}
...
func (privVal *ByzantinePrivValidator) String() string {
	return gcmn.Fmt("PrivValidator{%X}", privVal.Address)
}
