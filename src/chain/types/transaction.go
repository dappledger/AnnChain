...
type (
	...
	Device struct {
		Deviceid   string         `json:"deveiceid"`
		Status     uint8          `json:"status"`
		Owner      common.Address `json:"owner"`
		ChangeDate uint64         `json:"changedate"`
		Modifier   common.Address `json:"modifier"`
	}
	...
	Pay struct {
		...
		ProfitPercent uint64         `json:"profitpercent"`
		Platform      common.Address `json:"platform"`
	}
...
const (
	OP_ADD_DEVICE    = "adddevice"
	OP_UPDATE_DEVICE = "updatedevice"
...
const (
	ERROR_ACCOUNT_NOTEXIST = "account not exist"
)
