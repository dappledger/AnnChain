...
${ANNPATH}/anntool --callmode="commit" --backend="tcp://127.0.0.1:16657" --target="annchain-gGgTjd" organization create --genesisfile ./shards/evm2/genesis1.json --configfile ./shards/evm2/config1.json --privkey="${PRIV1}"

wait_five_seconds

echo "Start joining..."

${ANNPATH}/anntool --callmode="commit" --backend="tcp://127.0.0.1:26657" --target="annchain-gGgTjd" organization join --configfile ./shards/evm2/config2.json --privkey="${PRIV2}" --orgid="${ORGID}"
...
${ANNPATH}/anntool --callmode="commit" --backend="tcp://127.0.0.1:36657" --target="annchain-gGgTjd" organization join --configfile ./shards/evm2/config3.json --privkey="${PRIV3}" --orgid="${ORGID}"
...
${ANNPATH}/anntool --callmode="commit" --backend="tcp://127.0.0.1:36657" --target="annchain-gGgTjd" organization join --configfile ./shards/evm2/config4.json --privkey="${PRIV4}" --orgid="${ORGID}"
